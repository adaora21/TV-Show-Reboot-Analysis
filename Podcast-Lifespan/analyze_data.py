...
def histogram(release_period_df):
    ...
    plt.title('Distribution of the Lifespans of the Top 50 Podcasts in the U.S. in 2021', fontsize=16, fontweight='semibold')
    plt.xlabel("Podcast Lifespan (yrs)", fontdict={'fontsize': 12}, horizontalalignment="center")
    plt.ylabel("Frequency", fontdict={'fontsize': 12}, horizontalalignment="center")

    # Add footnotes
    plt.text(0, -0.9,
            'Podcast Lifespan = Most recent podcast episode release date - First podcast episode release date; '
            'Podcast lifespan calculated as of April 1 2022'
