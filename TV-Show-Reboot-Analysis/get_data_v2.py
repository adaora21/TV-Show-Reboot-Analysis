...
def get_wiki_table(URL, table_list):
    ...
    num_tables: List of tables that need to be recorded from the Wikipedia link
...
if __name__ == "__main__":
    ...
    # (Example: [1, 2, 28] = pull the 1st, 2nd and 31st tables from the list of ended Netflix
    # original programming on Wikipedia)
    ...
    titles = []
    # Iterate through each bullet on the webpage and record the TV show title
    ...
    Get manual data
    '''
    # Create list of tv reboots that were manually discovered
